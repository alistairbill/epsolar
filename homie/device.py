...
from homie.network import get_local_ip, get_local_mac, get_wifi_strength
...
class HomieDevice:
    ...
    async def publish_stats(self):
        ...
        _tsg = "{}/$stats/signal".format(self.dtopic)  # Signal topic
        ...
        while True:
            ...
            await publish(_tsg, str(get_wifi_strength()))
            await sleep_ms(_d)
